...
public void createGUI(){
  ...
  toUserInfoTab = new GButton(dashboard, 130, 105, 140, 30);
  toUserInfoTab.setText("Modify User Info >");
  toUserInfoTab.setLocalColorScheme(GCScheme.CYAN_SCHEME);
  toUserInfoTab.addEventHandler(this, "toUserInfoTab_click");
  welcomeMessage = new GLabel(dashboard, 90, 50, 220, 20);
  ...
  toCustomPlanTab = new GButton(dashboard, 130, 145, 140, 30);
  toCustomPlanTab.setText("Create Custom Plan >");
  toCustomPlanTab.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  toCustomPlanTab.addEventHandler(this, "toCustomPlanTab_clicked");
  toDeletePlanTab = new GButton(dashboard, 130, 185, 140, 30);
  toDeletePlanTab.setText("Delete Custom Plan >");
  toDeletePlanTab.setLocalColorScheme(GCScheme.RED_SCHEME);
  toDeletePlanTab.addEventHandler(this, "toDeletePlanTab_click");
  newDayButton = new GButton(dashboard, 100, 235, 200, 30);
  newDayButton.setText("Click If A Day Has Passed");
  newDayButton.setLocalColorScheme(GCScheme.GOLD_SCHEME);
  newDayButton.addEventHandler(this, "newDayButton_click1");
  guideMessage = new GLabel(dashboard, 90, 70, 220, 20);
  guideMessage.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  guideMessage.setText("Press a button below to get started.");
  guideMessage.setOpaque(false);
  ...
  customNameLabel = new GLabel(customPlanTab, 62, 50, 140, 20);
  ...
  proteinPercentLabel = new GLabel(customPlanTab, 64, 75, 140, 20);
  ...
  carbPercentLabel = new GLabel(customPlanTab, 72, 98, 130, 20);
  ...
  percentTipLabel = new GLabel(customPlanTab, 51, 144, 290, 20);
  ...
  isMaintainBox = new GCheckbox(customPlanTab, 137, 182, 120, 20);
  ...
  isLoseBox = new GCheckbox(customPlanTab, 137, 203, 120, 20);
  ...
  customDaysLabel = new GLabel(customPlanTab, 106, 264, 90, 20);
  ...
  customDaysField = new GTextField(customPlanTab, 198, 264, 50, 20, G4P.SCROLLBARS_NONE);
  customDaysField.setOpaque(true);
  customDaysField.addEventHandler(this, "customDaysField_type");
  weightTipLabel = new GLabel(customPlanTab, 29, 225, 350, 40);
  weightTipLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  weightTipLabel.setText("(Tip: The Maintain Weight and Lose Weight options are mutually exclusive, meaning you may not select both.)");
  weightTipLabel.setOpaque(false);
  addPlanButton = new GButton(customPlanTab, 310, 263, 80, 30);
  addPlanButton.setText("Add Plan");
  addPlanButton.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  addPlanButton.addEventHandler(this, "addPlanButton_click1");
  weightGoalLabel = new GLabel(customPlanTab, 76, 182, 60, 20);
  weightGoalLabel.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  weightGoalLabel.setText("Goal:");
  weightGoalLabel.setOpaque(false);
  ...
  label2 = new GLabel(deletePlanTab, 18, 94, 150, 20);
  label2.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  label2.setText("Name of Plan to Delete:");
  label2.setOpaque(false);
  planToDeleteField = new GTextField(deletePlanTab, 169, 94, 200, 20, G4P.SCROLLBARS_NONE);
  planToDeleteField.setOpaque(true);
  planToDeleteField.addEventHandler(this, "planToDeleteField_type");
  deletePlanButton = new GButton(deletePlanTab, 150, 194, 90, 30);
  ...
  label3 = new GLabel(deletePlanTab, 80, 150, 240, 20);
